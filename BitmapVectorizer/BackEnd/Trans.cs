...
namespace BitmapVectorizer
{
    ...
    internal sealed class Trans
    {
        ...
        private readonly FLOAT[] bb;   /* dimensions of bounding box */
        private readonly FLOAT[] orig; /* origin relative to bounding box */
        private readonly FLOAT[] x;    /* basis vector for the "x" direction */
        private readonly FLOAT[] y;    /* basis vector for the "y" direction */
